...
import { CultivoResponse } from '../models/cultivo-response';
...
export class CultivoService {
  ...
  getCultivoId(token:any, id_cultivo:any):Observable<CultivoResponse>{
    const headers = new HttpHeaders({
      'Authorization': `Bearer ${token}`
    })
    return this.http.get<CultivoResponse>(`${this.__Parent.API_URL}cultivo/${id_cultivo}`, {headers: headers})
  }
